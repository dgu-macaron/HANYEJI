...
//write value
int dynamic_E_stop;//주고받는 값
int crosswalk_E_stop;//주고받는 값
int park_E_stop; //주고받는 값
int steer=0;//모니터링 하기 위한 값
uint8_t E_stop,steer1,steer2,speed,brake,gear; //주고받는 값
...
//    printf("========================\n");
    ...
    uint8_t ask[14]={0x53,0x54,0x58,0x01,E_stop,gear,0x00,speed,steer1,steer2,brake,a,0x0D,0x0A};  //보내는 값
